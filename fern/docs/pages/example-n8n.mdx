...
**Fulfill generated content** — if `content_type` is `generated`, call the **ListBee** node with **Operation: Fulfill** after generating content, passing `order_id` and the content to deliver.
