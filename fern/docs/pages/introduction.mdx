...
Three required fields: `name`, `price`, `currency`. Add `content` and the listing can sell immediately.
...
#   4. POST /v1/listings          { name, price, currency, content } → listing.url + readiness.sellable
#
